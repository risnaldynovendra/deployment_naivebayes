...
class TweetSentimentApp:
    def __init__(self):
        ...
        self.multinomial_naive_bayes_model = joblib.load('multinomial_naive_bayes_model.pkl') #load model
...
# =============================================================================================
    def find_user_with_highest_tweet_count(self, dataframe):
        # Group the dataframe by user name and count the number of tweets
        tweet_count_df = dataframe.groupby('username')['Ulasan'].count().reset_index()
        ...
        # Plot tweet count of each leader
        plt.bar(tweet_count_df['username'], tweet_count_df['Ulasan'], color=['red', 'green', 'blue'], width=0.3)
        plt.xlabel('Politician')
...
# =============================================================================================
    ...
    # ===================================================================================================================
    def run(self):
        st.title('PROGRAM ANALISIS SENTIMEN KATA')
        st.write("### Analisis Sentimen Kalimat")
        ...
        if st.button("Analisis"):
            if user_input:
                ...
                single_user_sentiment_df = pd.DataFrame({'Kalimat': [cleaned_input],
                                                         ...
                                                         'Sentimen Kalimat': [sentiment_tag],
        ...
        st.write("### Analisis Sentimen Dokumen")
        st.write("Hanya 2 kolom diperlukan, gunakan istilah 'Ulasan' dan 'username' untuk dapat dianalisis")
        uploaded_file = st.file_uploader('Upload file disini', type=['csv', 'xlsx'])
        ...
        if uploaded_file is not None:
            ...
            # =========================================================================================
            df['cleaned_text'] = df['Ulasan'].apply(self.clean_text)
...
if __name__ == '__main__':
    ...
    analyzer = TopicModelingAnalyzer(tfidf_vectorizer_path='multinomial_naive_bayes_model.pkl')
